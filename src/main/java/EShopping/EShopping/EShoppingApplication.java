...
import EShopping.EShopping.exceptions.ProblemDetails;
import EShopping.EShopping.exceptions.ValidationProblemDetails;
...
public class EShoppingApplication {
    ...
    public ProblemDetails handleBusinessException(MethodArgumentNotValidException methodArgumentNotValidException) {
        ...
        validationProblemDetails.setMessage("VALİDATİON_EXCEPTİON");
